...
def getParametrs(links):
    ...
    for link in links:
        if link=='https://dg-trade.ru/catalog/masla-i-smazki/motornye-masla/' or link=='https://dg-trade.ru/catalog/masla-i-smazki/transmissionnye-masla/' or link=='https://dg-trade.ru/catalog/masla-i-smazki/gidravlicheskie-masla/' or link=='https://dg-trade.ru/catalog/masla-i-smazki/smazki/' or link=='https://dg-trade.ru/catalog/masla-i-smazki/okhlazhdayushchaya-zhidkost/' or link=='https://dg-trade.ru/catalog/masla-i-smazki/toplivnye-prisadki/' or link == 'https://dg-trade.ru/catalog/masla-i-smazki/avtokhimiya/':
            continue
        linnk.append(link)
        counter+=1
    ...
    products=[date,time,linnk,brand,articul,description,linkPhoto,warehouse*counter,
